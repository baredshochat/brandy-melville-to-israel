...
import { X, Mail, FileText, Truck, Package, Trash2, Download, ClipboardList } from 'lucide-react';
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex gap-2">
              ...
              <Button variant="outline" size="sm" onClick={() => onAction('packingList')} className="text-purple-600 border-purple-200 hover:bg-purple-50">
