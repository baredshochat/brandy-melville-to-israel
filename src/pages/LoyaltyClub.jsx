      ...
      <Card className="bg-stone-50 border-stone-200">
        <CardContent className="pt-6">
          ...
          <ul className="space-y-2 text-sm text-stone-600">
            ...
            <li>• 100 נקודות = 50₪ הנחה (כל נקודה שווה חצי שקל)</li>
            <li>• מחברת רגילה: צבירת 5% מסכום ההזמנה</li>
            <li>• מחברת סילבר: צבירת 7% + משלוח חינם חד-פעמי</li>
            <li>• מחברת גולד: צבירת 10% + משלוח חינם חודשי</li>
            <li>• 5 הזמנות ב-6 חודשים = סילבר | 10 הזמנות = גולד</li>
