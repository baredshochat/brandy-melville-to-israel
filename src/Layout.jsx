...
import { Home, Package, Truck, Settings, Heart, FileText, Calculator, MessageSquare, BarChart3, User as UserIcon, DollarSign, Scan } from "lucide-react";
...
export default function Layout({ children }) {
  ...
  { name: "ProductScanner", label: "סורק מוצרים", icon: Scan, roles: ['admin'] },
